...
import {
    ...
    useProjectsStore,
    getTechObjects,
    fuctoryPointerGraphicObjects,
    fuctoryLinearGraphicObjects,
    type TechObjectDto,
    createTechObjects,
    type GraphicObjectDto,
    createEmptyTechObjectRegime,
    createGraphicObjects,
    createEmptyTechObjectPassport,
    fillColors,
    strokeColors,
    GraphicObjectTypeDto,
    filterTechObjectPassports,
    filterTechObjectsRegime,
    createTechObjectsPassport,
    createTechObjectRegimes,
    TechObjectTypeDto,
    ControlMode,
    getPassport,
    type PassportDto,
    convertTechToGraphicStepDiameter,
    type RegimeDto,
    ValveStateDto,
